...
local function StartupCode()
	table.iappend_unique(g_SanatoriumTraits, {"Introvert"}) -- Loner
	table.iappend_unique(g_SanatoriumTraits, {"Hypochondriac"})
	table.iappend_unique(g_SanatoriumTraits, {"Whiner"})
end
